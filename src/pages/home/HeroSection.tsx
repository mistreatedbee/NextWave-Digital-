      ...
      >
        <div className="max-w-[62rem]">
          ...
          >
            Websites, Apps & AI
            <br />
            <span className="shimmer-text">That Automate Your Growth</span>
          </motion.h1>
          ...
          >
            We build <span className="text-white font-medium">custom websites, mobile apps, AI automation, and task management systems</span> that save you time, cut costs, and scale with your business. 
            <span className="block mt-2 text-slate-300">South African owned — global expertise.</span>
          </motion.p>
